...
For usage manual and boot menu screenshots, see the [Ventoy USB usage guide](USAGE.md).
...
- 📁 Builds RTD folder layout and copies discovered ISO boot images grouped by type.
