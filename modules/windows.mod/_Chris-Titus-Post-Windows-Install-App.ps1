...
# ::
# ::    Special Thanks to:
# :: 	Primary Author Source:  Chris Titus
# ::    GitHub:                 https://github.com/ChrisTitusTech
# ::
# ::    Purpose:  This script is designed to automate the process of setting up a new Windows 10/11 installation.
# ::            - Remove unnecessary software from Windows 10/11
...
Stop-Transcriptteam "to use this tool."
